...
def main():
    ...
    # Separate parameters: backbone gets 0.1x learning rate, rest gets full learning rate
    train_params = [
    ...
    # Step scheduler: reduce LR by 0.1x every step_size iterations
    ...
    while True:  # cur_itrs < opts.total_itrs:
        ...
        print(f"Epoch {cur_epochs}: mIoU = {val_score['Mean IoU']:.4f}")
        ...
        # Save mIoU history for plotting
        np.save('checkpoints/mIoU_history.npy', np.array(mIoU_per_epoch))
